...
window.acequire = function(parentId, id) {
    ...
    chunks[0] = window.acequire.tlns[chunks[0]] || chunks[0];
...
ace.define('ace/mode/html_worker', ["require", 'exports', 'module' , 'ace/lib/oop', 'ace/lib/lang', 'ace/worker/mirror', 'ace/mode/html/saxparser'], function(acequire, exports, module) {


var oop = acequire("../lib/oop");
var lang = acequire("../lib/lang");
var Mirror = acequire("../worker/mirror").Mirror;
var SAXParser = acequire("./html/saxparser").SAXParser;
...
ace.define('ace/mode/html/saxparser', ["require", 'exports', 'module' ], function(acequire, exports, module) {
var req = acequire=(function(e,t,n){function i(n,s){if(!t[n]){if(!e[n]){var o=typeof acequire=="function"&&acequire;if(!s&&o)return o(n,!0);if(r)return r(n,!0);throw new Error("Cannot find module '"+n+"'")}var u=t[n]={exports:{}};e[n][0].call(u.exports,function(t){var r=e[n][1][t];return i(r?r:t)},u,u.exports)}return t[n].exports}var r=typeof acequire=="function"&&acequire;for(var s=0;s<n.length;s++)i(n[s]);return i})({1:[function(req,module,exports){
...
exports.SVGAttributeMap = {
	...
	edgemode:	'edgeMode',
	externalresourcesacequired:	'externalResourcesRequired',
	filterres:	'filterRes',
	...
	repeatdur:	'repeatDur',
	acequiredextensions:	'acequiredExtensions',
	acequiredfeatures:	'acequiredFeatures',
...
module.exports={
	...
	"unexpected-cell-end-tag":
		"Got table cell end tag ({name}) while acequired end tags are missing.",
